...
SPEC TRUE[*]; [CB] [ENTRY] [f] void android.support.v4.app.Fragment.onPause() |- [CI] [ENTRY] [f] void android.support.v4.app.Fragment.startActivity(i : android.content.Intent);
