...
SPEC view_lose_precision(view) & (TRUE[*] ; view_onClick_enabled_set_has(view);view_onClick_listener_set_just(view,listener)) |+ [CB] [ENTRY] [listener] void android.view.View$OnClickListener.onClick(view : android.view.View);

//setEnable enable
//SPEC (TRUE[*] ; view_onClick_listener_set_has(view,listener);view_onClick_enabled_set_just(view)) & view_lose_precision(view) |+ [CB] [ENTRY] [listener] void android.view.View$OnClickListener.onClick(view : android.view.View);
