...
SPEC view_lose_precision_has(view) & view_onClick_listener_set_just(view,listener) |+ [CB] [ENTRY] [listener] void android.view.View$OnClickListener.onClick(# : android.view.View);
...
SPEC view_onClick_listener_set_has(view,listener) &  view_lose_precision_just(view) |+ [CB] [ENTRY] [listener] void android.view.View$OnClickListener.onClick(# : android.view.View);
