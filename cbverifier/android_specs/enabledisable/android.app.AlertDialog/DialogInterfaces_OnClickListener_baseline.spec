...
SPEC (TRUE[*]; AlertDialog_builder_register(dialog,clickListener);TRUE[*]) & (TRUE[*];Activity_all_onResume(act)) & (TRUE[*];AlertDialog_attached_to_activity(act,dialog);TRUE[*])
...
SPEC (TRUE[*]; AlertDialog_builder_register(dialog,clickListener)) &  (TRUE[*];AlertDialog_attached_to_activity(act,dialog);TRUE[*]) & (TRUE[*]; Activity_all_onResume(act);((!(Activity_all_onPause(act))) & TRUE)[*])
  |+ [CB] [ENTRY] [clickListener] void android.content.DialogInterface$OnClickListener.onClick(dialog : android.content.DialogInterface,# : int);
...
SPEC (TRUE[*]; AlertDialog_builder_register(dialog, clickListener);TRUE[*]) & Activity_not_visible_just(act) & (TRUE[*];AlertDialog_attached_to_activity(act,dialog);TRUE[*])
 |- [CB] [ENTRY] [clickListener] void android.content.DialogInterface$OnClickListener.onClick(dialog : android.content.DialogInterface,# : int);

//show with no activity attached

SPEC (TRUE[*]; AlertDialog_builder_register(dialog, clickListener)) & AlertDialog_losePrecision(dialog)
  |+ [CB] [ENTRY] [clickListener] void android.content.DialogInterface$OnClickListener.onClick(dialog : android.content.DialogInterface,# : int);
