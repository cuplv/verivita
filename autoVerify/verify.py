...
if __name__ == "__main__":
   ...
   if len(sys.argv) != 6:
      print "usage: python verify.py <Path to Trace File> <'proto' or 'json'> <Path to Verifier> <Path to Spec Repository> <Comma Separated List of Spec Files>"
      sys.exit(1)
   ...
   results = runVerify(tracePath, specs, verifierPath, json=json)
