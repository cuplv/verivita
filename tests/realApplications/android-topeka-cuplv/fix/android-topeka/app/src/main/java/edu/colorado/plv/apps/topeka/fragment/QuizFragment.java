 ...
 */
package edu.colorado.plv.apps.topeka.fragment;
...
import edu.colorado.plv.apps.topeka.adapter.QuizAdapter;
import edu.colorado.plv.apps.topeka.adapter.ScoreAdapter;
import edu.colorado.plv.apps.topeka.helper.PreferencesHelper;
import edu.colorado.plv.apps.topeka.model.Category;
import edu.colorado.plv.apps.topeka.model.Player;
import edu.colorado.plv.apps.topeka.model.Theme;
import edu.colorado.plv.apps.topeka.model.quiz.Quiz;
import edu.colorado.plv.apps.topeka.persistence.TopekaDatabaseHelper;
import edu.colorado.plv.apps.topeka.widget.AvatarView;
import edu.colorado.plv.apps.topeka.widget.quiz.AbsQuizView;
...
public class QuizFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return themedInflater.inflate(edu.colorado.plv.apps.topeka.R.layout.fragment_quiz, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        mQuizView = (AdapterViewAnimator) view.findViewById(edu.colorado.plv.apps.topeka.R.id.quiz_view);
        decideOnViewToDisplay();
        mQuizView.setInAnimation(getActivity(), edu.colorado.plv.apps.topeka.R.animator.slide_in_bottom);
        mQuizView.setOutAnimation(getActivity(), edu.colorado.plv.apps.topeka.R.animator.slide_out_top);
        final AvatarView avatar = (AvatarView) view.findViewById(edu.colorado.plv.apps.topeka.R.id.avatar);
    ...
    private void initProgressToolbar(View view) {
        ...
        mProgressText = (TextView) view.findViewById(edu.colorado.plv.apps.topeka.R.id.progress_text);
        mProgressBar = ((ProgressBar) view.findViewById(edu.colorado.plv.apps.topeka.R.id.progress));
    ...
    private void setProgress(int currentQuizPosition) {
        ...
        mProgressText
                .setText(getString(edu.colorado.plv.apps.topeka.R.string.quiz_of_quizzes, currentQuizPosition, mQuizSize));
    ...
    public void showSummary() {
        @SuppressWarnings("ConstantConditions")
        final ListView scorecardView = (ListView) getView().findViewById(edu.colorado.plv.apps.topeka.R.id.scorecard);
