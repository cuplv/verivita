 ...
 */
package edu.colorado.plv.apps.topeka.adapter;
...
import edu.colorado.plv.apps.topeka.model.quiz.AlphaPickerQuiz;
import edu.colorado.plv.apps.topeka.model.quiz.FillBlankQuiz;
import edu.colorado.plv.apps.topeka.model.quiz.FillTwoBlanksQuiz;
import edu.colorado.plv.apps.topeka.model.quiz.FourQuarterQuiz;
import edu.colorado.plv.apps.topeka.model.quiz.MultiSelectQuiz;
import edu.colorado.plv.apps.topeka.model.quiz.PickerQuiz;
import edu.colorado.plv.apps.topeka.model.quiz.Quiz;
import edu.colorado.plv.apps.topeka.model.quiz.SelectItemQuiz;
import edu.colorado.plv.apps.topeka.model.quiz.ToggleTranslateQuiz;
import edu.colorado.plv.apps.topeka.model.quiz.TrueFalseQuiz;
import edu.colorado.plv.apps.topeka.widget.quiz.AbsQuizView;
import edu.colorado.plv.apps.topeka.widget.quiz.AlphaPickerQuizView;
import edu.colorado.plv.apps.topeka.widget.quiz.FillBlankQuizView;
import edu.colorado.plv.apps.topeka.widget.quiz.FillTwoBlanksQuizView;
import edu.colorado.plv.apps.topeka.widget.quiz.FourQuarterQuizView;
import edu.colorado.plv.apps.topeka.widget.quiz.MultiSelectQuizView;
import edu.colorado.plv.apps.topeka.widget.quiz.PickerQuizView;
import edu.colorado.plv.apps.topeka.widget.quiz.SelectItemQuizView;
import edu.colorado.plv.apps.topeka.widget.quiz.ToggleTranslateQuizView;
import edu.colorado.plv.apps.topeka.widget.quiz.TrueFalseQuizView;
