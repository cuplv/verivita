 ...
 */
package edu.colorado.plv.apps.topeka.persistence;
...
import edu.colorado.plv.apps.topeka.helper.JsonHelper;
import edu.colorado.plv.apps.topeka.model.Category;
import edu.colorado.plv.apps.topeka.model.JsonAttributes;
...
public class TopekaDatabaseHelper extends SQLiteOpenHelper {
    ...
    private String readCategoriesFromResources() throws IOException {
        ...
        InputStream rawCategories = mResources.openRawResource(edu.colorado.plv.apps.topeka.R.raw.categories);
