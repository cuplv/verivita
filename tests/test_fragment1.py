#! /usr/bin/env python
#################################################################################
#     File Name           :     test_fragment1.py
#     Created By          :     Peilun Zhang
#     Creation Date       :     [2016-09-15 09:09]
#     Description         :
#################################################################################
...
class TestSuite(unittest.TestCase):
    def test_fragment1(self):
        ...
        print BASE_DIR
        spec_file_list = ["Fragment.spec"]
        spec_file_list = [ os.path.join(BASE_DIR, a) for a in spec_file_list]
        tracefile = os.path.join(currentPath, "FragmentsReplaceInteractionBug/trace/trace1.json")
