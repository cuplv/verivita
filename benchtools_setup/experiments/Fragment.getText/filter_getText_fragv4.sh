...
python ~/Documents/source/TraceRunner/utils/ProtoConverter/filterProto.py --trace ${BASE_DIR}$1 --filter_class android.support.v4.app.Fragment --filter_method "java.lang.CharSequence getText(int)"
